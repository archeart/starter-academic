...
{{< staticref "files/research.pdf"  >}} research statement{{< icon name="file-pdf" pack="fas" >}}{{< /staticref >}}, 
{{< staticref "files/teaching.pdf"  >}} teaching statement{{< icon name="file-pdf" pack="fas" >}}{{< /staticref >}}, 
and {{< staticref "files/diversity.pdf"  >}} diversity statement{{< icon name="file-pdf" pack="fas" >}}{{< /staticref >}}.
